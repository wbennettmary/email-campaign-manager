...
# Email Campaign Manager - Complete Automated Installation Script
# This script will install everything from scratch on a fresh Ubuntu server
# Run as: sudo ./auto_install.sh
...
print_header "EMAIL CAMPAIGN MANAGER - AUTOMATED INSTALLATION"
